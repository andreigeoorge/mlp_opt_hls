...
set C_modelArgList {
	...
	{ layer_output double 64 regular {array 8 { 1 3 } 1 1 }  }
	{ layer_derivative double 64 regular {array 8 { 0 3 } 0 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.d_sigmoid_dmul_64cud_U2", "Parent" : "0"}]}
...
set ArgLastReadFirstWriteLatency {
	d_sigmoid {
		...
		layer_derivative {Type O LastRead -1 FirstWrite 12}}}
...
set Spec2ImplPortList { 
	...
	layer_output { ap_memory {  { layer_output_address0 mem_address 1 3 }  { layer_output_ce0 mem_ce 1 1 }  { layer_output_q0 mem_dout 0 64 } } }
	layer_derivative { ap_memory {  { layer_derivative_address0 mem_address 1 3 }  { layer_derivative_ce0 mem_ce 1 1 }  { layer_derivative_we0 mem_we 1 1 }  { layer_derivative_d0 mem_din 1 64 } } }
}
